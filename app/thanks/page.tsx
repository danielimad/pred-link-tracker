      ...
      <body>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (async () => {
            ...
            const scr = { w: screen.width, h: screen.height, aw: window.innerWidth, ah: window.innerHeight, dpr };
            ...
            await fetch('/api/client-meta', {
              ...
              body: JSON.stringify({ id, tz, lang, scr, mem, cores, conn, uaBrands, uaPlatform, uaModel, uaFull })
            });
          })();
        `}} />
      </body>
